...
export default function AIChat() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50 overflow-hidden">
      {/* Main Chat Container - Centered with 85% width and 90% height */}
      <div className="relative w-[85%] h-[90%] flex flex-col bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="flex items-center space-x-3">
            ...
            {tokenCredits.isConnected && (
              <div 
                ...
                onClick={toggleDashboard}
              >
                Tokens: {tokenCredits.tokenBalance}
              </div>
            )}
          </div>
                ...
                <div className="p-4 border-t">
                  {(parseInt(tokenCredits.tokenBalance) > 0 || !shouldUseTokens) ? (
                    ...
                    <div className="text-center py-2">
                      <p className="font-medium text-yellow-800 text-sm mb-2">You have no tokens remaining</p>
                      <Button
                        color="warning"
                        variant="flat"
                        size="sm"
